  ...
  return (
    <div className="flex justify-center ">
      <div className="rounded-lg shadow-lg bg-white max-w-sm">
        ...
        <div className="p-6">
          {title === "Limited" ? (
            <span className="bg-[#c70c45] text-white text-sm  mr-2 px-2.5 py-0.5 rounded   font-bold">
              LIMITED
            </span>
          ) : null}

          {title === "Event" ? (
            <span className="bg-[#3db88f] text-white text-sm  mr-2 px-2.5 py-0.5 rounded   font-bold">
              EVENT
            </span>
          ) : null}
